 ...
 * @version 1.0
 */
public class Service_1242_ENTITY {


    public static String dirPath = "C:\\dechun.yuan\\AIG\\Work\\AML\\API\\blacklist\\1242 ENTITY.XML";
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < entityList.size(); i++) {
            ...
            String dob = "";
            String blacklistSource = "1242_ENTITY";
            ...
            for (int m = 0; m < chineseNameList.size(); m++) {
                ...
                if (idList == null) {
                    HashMap<String, Object> idsMap = (HashMap<String, Object>) idsList.get("ids");
